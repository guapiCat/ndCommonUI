<template>
    <section>
        <nd-form ref="formRef" :model="form" inline label-width="120px" :label-position="labelPosition"
            :size="size">
        ...
        <h5>在组件中添加form-flex-between类名, 使用表单元素两端对齐</h5>
        <nd-form ref="formRef" class="form-flex-between" :model="form" inline label-width="120px" :label-position="labelPosition"
            :size="size">
            <nd-form-item label="Activity" prop="activity">
                <nd-input v-model="form.activity" />
            </nd-form-item>
